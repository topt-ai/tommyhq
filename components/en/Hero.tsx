...
export function Hero() {
  ...
  const line1 = 'Rank High on Google.'.split(' ');
  const line2 = 'Run on autopilot.'.split(' ');
      ...
      <div className="w-full max-w-[1200px] mx-auto px-6 md:px-12 relative z-10 flex items-center justify-between">
        <div className="max-w-[640px] GSAP-reveal" data-reveal>
          <div className="font-mono text-[11px] uppercase tracking-[0.15em] text-brand-accent mb-6">
            Websites &amp; Apps &nbsp;&middot;&nbsp; Local SEO &nbsp;&middot;&nbsp; Automations
          </div>
...
const QUERIES: Query[] = [
  {
    text: 'roofer contractor in greensboro',
    city: 'Greensboro, NC',
    rank: 2,
    stats: [
      { value: '37', label: 'Leads captured today' },
      { value: '100%', label: 'Auto-replied in < 1 min' },
    ],
  },
  {
    text: 'pressure washing in galveston',
    city: 'Galveston, TX',
    rank: 1,
    stats: [
      { value: '52', label: 'Calls booked this week' },
      { value: '4.9★', label: 'Avg review rating' },
    ],
  },
  {
    text: 'realtor in raleigh',
    city: 'Raleigh, NC',
    rank: 2,
    stats: [
      { value: '18', label: 'Showings scheduled' },
      { value: '2.3k', label: 'Map profile views' },
    ],
  },
  {
    text: 'hvac repair in austin',
    city: 'Austin, TX',
    rank: 1,
    stats: [
      { value: '41', label: 'Service requests today' },
      { value: '90s', label: 'Avg response time' },
    ],
  },
  {
    text: 'dentist near charlotte',
    city: 'Charlotte, NC',
    rank: 3,
    stats: [
      { value: '26', label: 'New patient forms' },
    ...
    >
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="font-mono text-[10px] uppercase text-[#4ADE80]">Live</span>
        </div>
      </div>
