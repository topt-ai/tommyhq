  ...
  return (
    ...
    >
      ...
      <a
        ...
        className="flex items-center justify-center w-[34px] h-[34px] rounded-full border border-brand-border text-[#4ADE80] hover:border-brand-border-hover hover:text-[#6EEB9E] transition-colors duration-250 shrink-0"
      >
      ...
      <ThemeToggle toLightLabel="Cambiar a modo claro" toDarkLabel="Cambiar a modo oscuro" />
      <button
